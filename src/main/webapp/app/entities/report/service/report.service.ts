...
export type PartialUpdateReport = Partial<IReport> & Pick<IReport, 'rid'>;
...
export class ReportService {
  ...
  getReportIdentifier(report: Pick<IReport, 'rid'>): string {
    return report.rid;
  }

  compareReport(o1: Pick<IReport, 'rid'> | null, o2: Pick<IReport, 'rid'> | null): boolean {
    return o1 && o2 ? this.getReportIdentifier(o1) === this.getReportIdentifier(o2) : o1 === o2;
  }

  addReportToCollectionIfMissing<Type extends Pick<IReport, 'rid'>>(
